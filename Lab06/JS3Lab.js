...
console.log(alphabetArray.reverse());//reverse mutates the and it changes the original.
...
console.log("Step 6:", array1[array1.length - 1]); // yes it did change! since I used .push() it adds the elements to the end. Yes I was!
...
const myTodoList = [];//Step 1
myTodoList.unshift("lotion", "deodorant", "toothpaste");//Step 2
console.log(myTodoList);
console.log(myTodoList.splice(1, 1,));// prints the element that was deleted
console.log(myTodoList);// Step 3 I did it right but the video is wrong she deletes the 3rd element and not the second!
const yourTodoList = ['sticks', 'cymbals'];//Step 4
console.log(yourTodoList);
const ourTodoList = myTodoList.concat(yourTodoList);//Step 5
...
// need to understand this better! /* Another way would be to make a for loop:
/*for (i = 0; i < x.length, i++)*/
/* ↑ YOUR CODE HERE ↑ */
 ...
 * Step 2: Uncomment the arguments (test cases) given below x
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
function reverse(x) {
