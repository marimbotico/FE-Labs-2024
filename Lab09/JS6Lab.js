...
arrayOfNumbers.sort((a, b) => a - b)// const cannot be reassigned so either switch to let or just delete the reassignment 
...
class Wallet {
  ...
  addMoney(amount) {
    this.money += amount// money was undefined so corrected version is this.money
  }
